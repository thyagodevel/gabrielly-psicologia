...
const ContainerContato = () => {
  return (
    <>
      ...
      <div className='flex flex-col items-center justify-center text-center bg-fundoContainerInicial'>
        <h1 className='text-fundoGeral font-merriLight'>
          Psicóloga Gabrielly Leal
        </h1>
        <h1 className='text-fundoGeral font-merriLight'>
          Todos os direitos reservados © 2023
        </h1>
        <h1 className='text-fundoGeral font-merriLight'>
          Desenvolvido por Thyago Cabral
        </h1>
      </div>
    </>
  );
